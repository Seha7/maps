...
var lyr_C10_1 = new ol.layer.Image({
                            opacity: 1,
                            title: 'Cумма температур почвы>10градусов <br><img src = "legend.png" width = "100px">',
...
var lyr_T_2 = new ol.layer.Vector({
                ...
                style: style_T_2,
                interactive: true,
    title: 'Tяжёлые металлы в почвах<br />\
    <img src="styles/legend/T_2_0.png" /> Районы по которым обследование <br> почв не проводилось<br />\
    <img src="styles/legend/T_2_1.png" /> Районы по которым проведено <br> обследование почв<br />'
        });
...
lyr_P_3.set('fieldAliases', {'name': 'Название района', 'area': 'Площадь, га', 'plow': 'Площадь обрабатываемых земель, га', });
